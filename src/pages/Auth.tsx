...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-primary/5 to-secondary/5">
      <Card className="w-full max-w-md p-8 bg-card/50 backdrop-blur-xl border-2">
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="relative">
            <Zap className="w-10 h-10 text-primary animate-pulse-glow" />
            <Zap className="w-10 h-10 text-secondary absolute inset-0 animate-pulse opacity-50" />
          </div>
